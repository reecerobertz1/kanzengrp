...
class Roles(commands.Cog):
    ...
    def get_pronouns_menu(self):
        ...
        pronouns_menu.add_option(label="She/Her", value="she_her", role_id=1122635691487137884)
        pronouns_menu.add_option(label="He/Him", value="he_him", role_id=1121852424353755137)
        pronouns_menu.add_option(label="They/Them", value="they_them", role_id=1122635724559241317)
    ...
    async def on_select_option(self, interaction: discord.Interaction):
        ...
        if interaction.custom_id == "pronouns_menu":
            role_id = interaction.data["values"][0].get("role_id")
