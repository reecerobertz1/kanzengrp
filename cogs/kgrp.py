...
class kanzen(commands.Cog):
    ...
    async def halloweentot(self, ctx):
        view=trickortreat()
        await ctx.send("🎃 **HALLOWEEN TRICK OR TREAT**\nThis year, instead of Secret Santa, we're doing a Halloween twist!\n\n**HOW IT WORKS:**\n- Everyone gets paired up randomly.\n- Click the ''join'' button below and share your Instagram username and a list of your biases or fave celebs (if you have a long list, just send your ults).\n- Now, you can either make an edit for your partner and edit their bias or play a little trick by editing someone/something else.\n- Don't forget to use __**#kanzentrickortreat**__ when you post.\n- If you join, you'll get a message from <@849682093575372841> on October 1st with your partner's details.\n\n**EXTRA INFO:**\n- Participating in this event earns you **3500xp**.\n- A channel will be made on october 1st for you to send your edits in to earn the xp\n- You can post your edit anytime in October.\n@everyone", view=view)
    ...
    async def totpartners(self, ctx):
        ...
        for i in range(0, len(biases_data), 2):
            ...
            pairs.append(f"```Partners```\n__**{user1_instagram}**__ \n{user1_reason}\n\n**__{user2_instagram}__**\n{user2_reason}\n")
        await ctx.send('\n'.join(pairs))
