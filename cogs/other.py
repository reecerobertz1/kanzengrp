...
class other(commands.Cog):
    ...
    async def on_message(self, message):
        ...
        if "MessageType.premium_guild" in str(message.type):
            embed = discord.Embed(title=f"KANZEN BOOST", description="<:CF10:1208857270109077614> Thank you for boosting reeceroberts\n<:CF10:1208857270109077614> Do `+perks` to claim our booster perks\n<:CF10:1208857270109077614> Dm staff or lead to get your custom role", color=0x2b2d31)
            embed.set_author(name=message.author.display_name, icon_url=message.author.display_avatar)
            embed.set_footer(text=f"We are now tat {message.guild.premium_subscription_count} boosts! thank you for the support")
