...
class other(commands.Cog):
    ...
    async def botinfo(self, ctx):
        ...
        embed.add_field(name="Owner", value="<@1077841960691322921>")
        ...
        embed.add_field(name="Created At", value=self.bot.user.created_at.strftime("%Y-%m-%d %H:%M:%S"))
        embed.add_field(name="Library", value="discord.py")
        embed.add_field(name="Python Version", value="3.11")
        embed.add_field(name="Uptime", value=str(self.bot.launch_time))
        embed.add_field(name="Coded by", value="<@1077841960691322921> & <@609515684740988959>")
