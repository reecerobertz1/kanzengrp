...
class welcandleave(commands.Cog):
    ...
    async def on_member_join(self ,member: discord.Member):
        ...
        # CHROMA COMMUNITY WELCOME EMBED
            ...
            embed2 = discord.Embed(color=0x2b2d31, description=f"## ᯓ Welcome {member.name} ༝ ⁺\n<:redpoint:1348433483844030484>Please make sure to [verify](https://discord.com/channels/835495688832811039/1341728546946682941)\n<:redpoint:1348433483844030484>Read our [rules](https://discord.com/channels/835495688832811039/1283439723053977730)\n<:redpoint:1348433483844030484>Come and get your [roles](https://discord.com/channels/835495688832811039/1340656462342393918)")
