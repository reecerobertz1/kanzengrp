    ...
    async def help(self, ctx):
        ...
        async def dropdown_callback(interaction: discord.Interaction):
            ...
            if selected_category == categories[0]:
                ...
                embed.add_field(name="+add", value="<a:Arrow_1:1145603161701224528> Add xp to a member", inline=False)
                embed.add_field(name="+multiadd", value="<a:Arrow_1:1145603161701224528> Add xp to multiple members", inline=False)
                embed.add_field(name="+remove", value="<a:Arrow_1:1145603161701224528> Remove xp from a member", inline=False)
                embed.add_field(name="+reset", value="<a:Arrow_1:1145603161701224528> Resets xp for everyone", inline=False)
                embed.add_field(name="+levelling on/off", value="<a:Arrow_1:1145603161701224528> Enables/disables the levelling system for the server", inline=False)
