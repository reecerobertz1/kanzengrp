    ...
    async def help(self, ctx):
        ...
        async def dropdown_callback(interaction: discord.Interaction):
            ...
            if selected_category == categories[0]:
                ...
                embed.add_field(name="+accept @mention", value="<a:bounceyarrow:1128155233437106187> Accepts member into kanzen", inline=False)
                embed.add_field(name="+decline @mention", value="<a:bounceyarrow:1128155233437106187> Declines a member from kanzen", inline=False)
