    ...
    async def help(self, ctx):
        categories = {
            ...
            "> Editing commands": [
                ...
                {"name": "+audio (isn't working)", "value": "Get an audio added by a member to use for your edit", "inline": False},
                {"name": "+addaudio (isn't working)", "value": "Add an audio from SoundCloud for others to use", "inline": False},
