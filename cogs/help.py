    ...
    async def help(self, ctx):
        ...
        async def dropdown_callback(interaction: discord.Interaction):
            ...
            if selected_category == categories[0]:
                ...
                embed.add_field(name="+effects", value="<a:Arrow_1:1145603161701224528> Get a random effect to use in your edit", inline=False)
