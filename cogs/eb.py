...
class ebmessages(commands.Cog):
    ...
    async def kdopen(self, ctx):
            ...
            embed.set_image(url="https://cdn.discordapp.com/attachments/1184208577120960632/1189046317297696888/BTS_Fila_Fall_2020_Collection_all-2000x1991_00000.png?ex=659cbcad&is=658a47ad&hm=a77fef71cc0841e54c52154f15b963bd2818eb69d3a99e0b3441644106c89038&")
            embed.set_thumbnail(url="https://cdn.discordapp.com/attachments/1184208577120960632/1189046299287371846/Comp_1_00000.png?ex=659cbca9&is=658a47a9&hm=de7c331842a84a14f07a33dae6f124aef927e7d32622e33362c149ced4e7d379&")
    ...
    @app_commands.command(name="kanzengrp", description="apply for kanzengrp")
    async def kanzengrp(self, interaction: discord.Interaction):
        await interaction.response.send_modal(kapps())

    @app_commands.command(name="daegutown", description="apply for daegutown")
    async def daegutown(self, interaction: discord.Interaction):
        await interaction.response.send_modal(dapps())
