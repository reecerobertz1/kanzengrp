...
class levels(commands.Cog):
    def __init__(self, bot):
        ...
        self.pool = None
        self.channels = [1184208577120960632, 1214944837451780116, 1181419043153002546, 1220487352733138954, 1220488547203547267, 1133767338588639323, 1214940039335641089]
