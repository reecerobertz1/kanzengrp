...
class EmbedCreator(View):
    ...
    def get_default_embed(self) -> Embed:
        ...
        embed.set_author(name='Embed Builder',
                         icon_url="https://cdn.discordapp.com/attachments/1121841074512605186/1141957072901132348/f04c5815341216fdafe736a2564a4d09.png")
        embed.set_thumbnail(
            url="https://cdn.discordapp.com/attachments/1121841074512605186/1141957120279982180/thumbnail_00000.png")
        embed.set_image(
            url="https://cdn.discordapp.com/attachments/1121841074512605186/1141957101275582464/image_00000.png")
        embed.set_footer(
            text='Footer', icon_url="https://cdn.discordapp.com/attachments/1121841074512605186/1141957072901132348/f04c5815341216fdafe736a2564a4d09.png")
        return embed
