...
class EmbedCreator(View):
        ...
        self.options_data = [
            {
                ...
                "emoji": kwargs.get("author_emoji", "<a:Arrow_1:1145603161701224528>"),
                "value": "author",
            },
            {
                "label": kwargs.get(
                ...
                "emoji": kwargs.get("message_emoji", "<a:Arrow_1:1145603161701224528>"),
                "value": "message",
            },
            {
                ...
                "emoji": kwargs.get("thumbnail_emoji", "<a:Arrow_1:1145603161701224528>"),
                "value": "thumbnail",
            },
            {
                ...
                "emoji": kwargs.get("image_emoji", "<a:Arrow_1:1145603161701224528>"),
                "value": "image",
            },
            {
                ...
                "emoji": kwargs.get("footer_emoji", "<a:Arrow_1:1145603161701224528>"),
                "value": "footer",
            },
            {
                ...
                "emoji": kwargs.get("color_emoji", "<a:Arrow_1:1145603161701224528>"),
                "value": "color",
            },
            {
                ...
                "emoji": kwargs.get("addfield_emoji", "<a:Arrow_1:1145603161701224528>"),
                "value": "addfield",
            },
            {
                ...
                "emoji": kwargs.get("removefield_emoji", "<a:Arrow_1:1145603161701224528>"),
                "value": "removefield",
            },
        ]
    ...
    def get_default_embed(self) -> Embed:
        ...
        embed = Embed(title='This is title',
                      description="Use the dropdown menu to edit!", colour=0x2b2d31)
        embed.set_author(name='Embed Builder',
                         icon_url="https://cdn.discordapp.com/attachments/1121841074512605186/1161324557093830877/FnFFrTEagAI4490_00000.png?ex=6537e2c6&is=65256dc6&hm=d655606503efe178b4dcb6bf02d8313d9f69475177f469b1d0db3da8905bfde2&")
        embed.set_thumbnail(
            url="https://cdn.discordapp.com/attachments/1121841074512605186/1161324557093830877/FnFFrTEagAI4490_00000.png?ex=6537e2c6&is=65256dc6&hm=d655606503efe178b4dcb6bf02d8313d9f69475177f469b1d0db3da8905bfde2&")
        embed.set_image(
            url="https://cdn.discordapp.com/attachments/1121841074512605186/1161323212978790410/image_00000.png?ex=6537e186&is=65256c86&hm=5d6357358104394a3857510260600d82709ad5371181dea1e51e4bdd0ee1b28e&")
        embed.set_footer(
            text='Footer', icon_url="https://cdn.discordapp.com/attachments/1121841074512605186/1161324557093830877/FnFFrTEagAI4490_00000.png?ex=6537e2c6&is=65256dc6&hm=d655606503efe178b4dcb6bf02d8313d9f69475177f469b1d0db3da8905bfde2&")
        return embed
